...
Now that the model and data have been defined, we are ready for MCMC. We will also made it such that the code is reproducible by setting a seed within JAGS.

```{r eval = F}
# set seed
inits_ls <- list(".RNG.name" = "base::Wichmann-Hill", ".RNG.seed" = 412)
n_chain <- 2
